            ...
            <form action="{{ route('dashboard.product.update', $item->slug) }}" class="w-full" method="POST" enctype="multipart/form-data">
                ...
                <div class="flex flex-wrap -mx-4 mb-6">
                    ...
                    <div class="w-full px-3">
                        ...
                        <input type="text" required value="{{ old('name') ?? $item->name }}" name="name" placeholder="Input Item Name Here" class="block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
                    </div>
                    {{-- input brand --}}
                </div>
                <div class="flex flex-wrap -mx-4 mb-6">
